...
namespace DbUserConversations.Services
{
    public interface IConversationService
    {
        ...
        Task<ServiceResponse<GetConversationDto>> GetConversationById(ClaimsPrincipal claimsPrincipal, string id);
        Task<ServiceResponse<GetConversationDto>> AddConversation(ClaimsPrincipal claimsPrincipal);
